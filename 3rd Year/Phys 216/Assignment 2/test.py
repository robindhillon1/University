# -*- coding: utf-8 -*-
"""
Created on Mon Jan 28 20:32:24 2019
...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 22 12:03:19 2019
...
yPC = yFinList[-2] + vFinal*deltatPC
yFinList[-1] = yPC
print('Final position before and after interpolation respectively: {:3.3f}, {:3.1f}'.format(yoldPC, yFinList[-1]))
