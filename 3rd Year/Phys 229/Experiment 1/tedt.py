...
plt.plot(freq, combined2(freq, *popt3), 'r:', linewidth = 2, label = 'Combined Fit')
plt.errorbar(freq, amp, yerr= ampUnc, c = 'black', marker= '.', linestyle = '')
plt.plot(freq, amp, 'ko', markersize = 1.5, label = 'actual')
plt.axvline(popt3[1], linestyle = '--', color = 'green')
